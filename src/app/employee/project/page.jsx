...
export default function EmployeeProjectListPage() {
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white py-12 px-6">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="bg-blue-500 rounded-2xl p-6 shadow-lg text-white">
          <h1 className="text-4xl font-bold mb-2">Manage Your Projects</h1>
          <p className="text-lg">View, edit, or delete your assigned projects.</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow p-6 grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 items-end">
          <div className="col-span-1 sm:col-span-2 flex flex-col">
            ...
            <input
              ...
              className="w-full pl-4 pr-4 py-3 rounded-full border border-gray-300 focus:ring-2 focus:ring-blue-400 focus:outline-none shadow-sm text-gray-800"
            ...
            {display.map((p) => (
              <div key={p._id} className="bg-white rounded-2xl shadow hover:shadow-xl transition p-6 flex flex-col justify-between">
                ...
                <div className="mt-4 flex gap-3">
                  <button
                    onClick={() => router.push(`/employee/project/edit-project/${p._id}`)}
