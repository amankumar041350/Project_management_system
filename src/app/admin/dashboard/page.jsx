  ...
  return (
    <div className="flex min-h-screen">
      ...
      <main className="flex-1 bg-gray-100">
        <AdminTopbar onSearchResults={setSearchResults} />
              ...
              <div className="max-h-[80vh] overflow-y-auto pr-2 space-y-4">
                ...
                {searchResults.tasks.map((task) => (
                  <div key={task._id} className="bg-white p-5 rounded-lg shadow">
                    ...
                    <p className="text-gray-600 mb-1"><strong>Assigned Date:</strong> {new Date(task.taskAssignDate).toLocaleDateString()}</p>
                    {task.completedBy && (
