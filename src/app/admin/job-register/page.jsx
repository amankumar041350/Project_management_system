    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white p-6 text-gray-800">
      <div className="max-w-7xl mx-auto space-y-8">
        <div className="flex justify-between items-center">
          ...
          <button
            onClick={() => router.push('/admin/job-register/new')}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 text-gray-800">
          {filtered.map((job) => (
            <div key={job._id} className="bg-white p-6 rounded-2xl shadow-lg border border-gray-200 hover:shadow-xl transition flex flex-col justify-between">
              ...
              <div className="flex gap-3 pt-4 mt-4 border-t border-gray-200">
                <button
                  onClick={() => router.push(`/admin/job-register/${job._id}`)}
